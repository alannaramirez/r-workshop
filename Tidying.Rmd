...
we can use a single colon (:) to indicate a series of sequential columns. A:D
```{r}
...
Create a new object called 'inverts_moyr' starting from inverts_long that unites the month and year columns into a SINGLE column named "mo_yr", unsing a "/" as the separator...then try some other fun separator.
